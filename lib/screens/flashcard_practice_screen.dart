...
class _FlashcardPracticeScreenState extends State<FlashcardPracticeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Practice Session (${_currentIndex + 1}/${_practiceStack.length})', style: const TextStyle(fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
          ...
          onPressed: () {
            showDialog(
              ...
              builder: (context) => AlertDialog(
                ...
                title: const Text('Exit Session?', style: TextStyle(color: AppColors.textPrimary, fontWeight: FontWeight.bold)),
                content: const Text('Your current practice progress will not be summarized, though saved scores remain. Exit anyway?', style: TextStyle(color: AppColors.textSecondary)),
                ...
                actions: [
                  TextButton(
                    ...
                    child: const Text('Resume', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold)),
                  ),
                  TextButton(
                    onPressed: () {
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: OutlinedButton.icon(
                                ...
                                label: const Text('FORGOT', style: TextStyle(color: AppColors.error, fontWeight: FontWeight.bold)),
  ...
  Widget _buildSummaryMetric(String label, String value, Color color, IconData icon) {
    return Container(
      decoration: AppColors.glassCardDecoration(radius: 20),
      padding: const EdgeInsets.all(16),
      child: Column(
        children: [
